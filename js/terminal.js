...
function executeCmd(e) {
    ...
    if ((e.which == 13) || (e.keyCode == 13))
    {
        ...
        switch(cmd[0].toUpperCase())
        {
            ...
            message += "<p>I'm constantly learning new languages and technologies. Right now I'm building <span class='highlight'>microservices</span> in <span class='highlight'>Go</span> in my spare time. I also like to solve problems using my box of tools. My next goal is to write a program that maps the 'Identity-H' encoding in PDF to unicode so that embeded fonts of this kind can become copy-able.</p>";
            message += "</div>";
            break;
            case "EDUCATION":
            ...
            break;
            case "EXPERIENCE":
            message = "--------<br /><span class='tip'>Room One Ltd</span>, London, 2018/01/03 - 2018/03/31<br /> Software Developer<br /><ul type='Circle'><li>Programmed UR3 robot using Python and ROS such that it can be controlled over the network using Xbox Kinect to mimick user's leg movement.</li><li>Optimised synchronisation by using asynchronous HTTP requests.</li><li>Reduced latency via MPTCP proxy. <a href='https://twitter.com/roomonelondon/status/969268929565782017'>Link</a></li></ul>--------<br /><span class='tip'>KCL Ericsson 5G Lab</span>, London, 2017/09/05 - 2018/03/31<br />Network Engineer<br /><ul type='Circle'><li>Implemented MPTCP/IP proxy in C and deployed on a Linux server.</li></ul>--------<br /><span class='tip'>Runwedia</span>, Taipei, 2017/07/21 - 2017/08/31<br />Frontend Developer Intern<br /><ul><li>Designed and built websites using Javascript, PHP, HTML and CSS.</li></ul>--------<br /><span class='tip'>Cyberlink</span>, Taipei, 2016/06/01 - 2016/08/25<br />UI Designer Intern<br /><ul><li>Designed icons and graphics using Adobe Photoshop and Illustrator.</li></ul>";
            break;
            case "ACTIVITIES":
            message = "--------<br /><span class='tip'>Facebook Hack A Project</span>,  London, 2018/10 - 2018/11<br /><ul type='Circle'><li>6-week program at Facebook HQ with mentoring support from senior software engineers. </li><li>Worked on the backend of an Android App that uses Node.js with Express framework and Heroku for infrastructure.</li></ul>--------<br /><span class='tip'>China Internet Industry Immersion Trip</span><br />Beijing, 2017/08<br /><ul type='Circle'><li>Rotated around different departments during the internship at Xinhuanet.</li><li> Visited Huawei, Mobike and JD.com.</li></ul>--------";
            break;
            case "CONTACT":
